...
public partial class RedisDataProvider
{
    ...
    public class EvictAsyncShould
    {
        ...
        public async Task ReturnExceptionErrorWhenExIsCaught()
        {
            ...
            // Act 
            var result =
                await _fixture.Service.EvictAsync<Session>(_fixture.SessionKey, new SessionEntryOptions(),
        ...
        public async Task UseProperLuaScript()
        {
            ...
            // Act 
            _ = await _fixture.Service.EvictAsync<Session>(_fixture.SessionKey, new SessionEntryOptions(),
                CancellationToken.None);
