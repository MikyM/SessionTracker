...
public partial class RedisDataProvider
{
    ...
    public class GetAsyncAsyncShould
    {
        private readonly RedisSessionTrackerDataProviderTestsFixture _fixture;

        public GetAsyncAsyncShould(RedisSessionTrackerDataProviderTestsFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task ThrowWhenCtCancelled()
        {
            ...
            await Assert.ThrowsAsync<OperationCanceledException>(async () =>
                await _fixture.DataProvider.GetAsync<Session>(_fixture.SessionKey, cts.Token));
        }
        ...
        public async Task ReturnExceptionErrorWhenExIsCaught()
        {
            ...
            // Act 
            var result = await _fixture.DataProvider.GetAsync<Session>(_fixture.SessionKey, CancellationToken.None);
        ...
        public async Task UseProperLuaScript()
        {
            ...
            // Act 
            _ = await _fixture.DataProvider.GetAsync<Session>(_fixture.SessionKey, CancellationToken.None);
