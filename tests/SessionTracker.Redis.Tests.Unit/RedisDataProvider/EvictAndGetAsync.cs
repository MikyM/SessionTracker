    ...
    public class EvictAndGetAsyncShould
    {
        ...
        public async Task ThrowWhenCtCancelled()
        {
            ...
            await Assert.ThrowsAsync<OperationCanceledException>(async () =>
                await _fixture.DataProvider.EvictAndGetAsync<Session>(_fixture.SessionKey, new SessionEntryOptions(),
                    cts.Token));
        }
        ...
        public async Task UseProperLuaScript()
        {
            ...
            // Act 
            _ = await _fixture.DataProvider.EvictAndGetAsync<Session>(_fixture.SessionKey, new SessionEntryOptions(),
                CancellationToken.None);
        ...
        public async Task ReturnSessionAlreadyEvictedErrorWhenRedisResultIs0()
        {
            ...
            // Act 
            var result = await _fixture.DataProvider.EvictAndGetAsync<Session>(_fixture.SessionKey,
        ...
        public async Task PassProperRedisValuesToScriptEvaluateAsync()
        {
            ...
            // Act 
            _ = await _fixture.DataProvider.EvictAndGetAsync<Session>(_fixture.SessionKey, opt, CancellationToken.None);
        ...
        public async Task ReturnSuccess()
        {
            ...
            // Act 
            var result = await _fixture.DataProvider.EvictAndGetAsync<Session>(_fixture.SessionKey, opt, CancellationToken.None);
