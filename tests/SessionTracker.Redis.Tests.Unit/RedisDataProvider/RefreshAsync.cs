    ...
    public class RefreshAsyncShould
    {
        ...
        public async Task RefreshAsyncShouldThrowWhenCtCancelled()
        {
            ...
            await Assert.ThrowsAsync<OperationCanceledException>(async () =>
                await _fixture.DataProvider.RefreshAsync<Session>(_fixture.SessionKey, cts.Token));
        }
        ...
        public async Task RefreshAsyncShouldReturnExceptionErrorWhenExIsCaught()
        {
            ...
            // Act 
            var result = await _fixture.DataProvider.RefreshAsync<Session>(_fixture.SessionKey, CancellationToken.None);
        ...
        public async Task UseProperLuaScript()
        {
            ...
            // Act 
            _ = await _fixture.DataProvider.RefreshAsync<Session>(_fixture.SessionKey, CancellationToken.None);
