...
public partial class RedisDataProvider
{
    ...
    public class RestoreAsyncShould
    {
        private readonly RedisSessionTrackerDataProviderTestsFixture _fixture;

        public RestoreAsyncShould(RedisSessionTrackerDataProviderTestsFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task ThrowWhenCtCancelled()
        {
            ...
            await Assert.ThrowsAsync<OperationCanceledException>(async () =>
                await _fixture.DataProvider.RestoreAsync<Session>(_fixture.SessionKey, new SessionEntryOptions(),
                    cts.Token));
        }
        ...
        public async Task ReturnExceptionErrorWhenExIsCaught()
        {
            ...
            // Act 
            var result = await _fixture.DataProvider.RestoreAsync<Session>(_fixture.SessionKey, new SessionEntryOptions(),
        ...
        public async Task UseProperLuaScript()
        {
            ...
            // Act 
            _ = await _fixture.DataProvider.RestoreAsync<Session>(_fixture.SessionKey, new SessionEntryOptions(),
                CancellationToken.None);
        ...
        public async Task PassProperRedisValuesToScriptEvaluateAsync()
        {
            ...
            // Act 
            _ = await _fixture.DataProvider.RestoreAsync<Session>(_fixture.SessionKey, opt, CancellationToken.None);
        ...
        public async Task ReturnSuccess()
        {
            ...
            // Act 
            var result = await _fixture.DataProvider.RestoreAsync<Session>(_fixture.SessionKey, opt, CancellationToken.None);
