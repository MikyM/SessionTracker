    ...
    public class GetEvictedAsyncShould
    {
        ...
        public async Task ThrowWhenCtCancelled()
        {
            ...
            await Assert.ThrowsAsync<OperationCanceledException>(async () =>
                await _fixture.DataProvider.GetEvictedAsync<Session>(_fixture.SessionKey, cts.Token));
        }
        ...
        public async Task ReturnExceptionErrorWhenExIsCaught()
        {
            ...
            // Act 
            var result = await _fixture.DataProvider.GetEvictedAsync<Session>(_fixture.SessionKey, CancellationToken.None);
        ...
        public async Task UseProperLuaScript()
        {
            ...
            // Act 
            _ = await _fixture.DataProvider.GetEvictedAsync<Session>(_fixture.SessionKey, CancellationToken.None);
        ...
        public async Task PassProperRedisValuesToScriptEvaluateAsync()
        {
            ...
            _fixture.DatabaseMock.Verify(x => x.ScriptEvaluateAsync(It.IsAny<string>(),
                It.IsAny<RedisKey[]?>(),
                It.Is<RedisValue[]?>(y => y != null && y.Length == 2 && y[0] == "1" && y[1] == _fixture.TestKey),
                It.IsAny<CommandFlags>()), Times.Once);
        }
