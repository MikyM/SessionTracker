    ...
    public class ResumeAsyncShould
    {
        ...
        public async Task ThrowWhenCtCancelled()
        {
            ...
            await Assert.ThrowsAsync<OperationCanceledException>(async () =>
                await _fixture.Service.ResumeAsync<Session>(_fixture.TestSessionKey, cts.Token));
        }
        ...
        public async Task ReturnSuccess()
        {
            ...
            _fixture.DataProviderMock.Verify(x => x.RestoreAsync<Session>(_fixture.TestSessionKey,
        ...
        public async Task ReturnExceptionErrorWhenExIsCaught()
        {
            ...
            _fixture.DataProviderMock.Setup(x =>
                x.RestoreAsync<Session>(_fixture.TestSessionKey, It.IsAny<SessionEntryOptions>(),
