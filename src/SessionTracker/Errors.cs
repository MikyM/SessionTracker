...
/// <summary>
/// Error that occurs when attempting to update a session when the session associated with the given key is already finished.
/// </summary>
[PublicAPI]
public record SessionAlreadyFinishedError() : ResultError("Session associated with the given key is already finished.");
